...
// Функция - Получить массивы символов
//
// Параметры:
//  Типы	 - Строка - ИзПараметра, КирилицаЗаглавная, КирилицаСтрочная, ЛатиницаЗаглавная, ЛатиницаСтрочная, Цифры, ПрочиеСимволыДоступныеВПеременных  
//  Смволы	 - Строка - сиволы для ИзПараметра
// 
// Возвращаемое значение:
//  Массив - 
...
// Функция - Оставить в строке символы из массива
//
// Параметры:
//  Строка			 - Строка - Строка для фильтрации
//  МассивСимволов	 - Массив - Массив симолов которые нужно оставить в стоке
// 
// Возвращаемое значение:
// Строка - Строка после фильтрации
//
